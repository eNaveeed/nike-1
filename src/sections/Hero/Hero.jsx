...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="item-center relative flex flex-1 justify-center bg-primary bg-hero bg-cover bg-center max-xl:py-40 xl:min-h-screen">
        <img
          src={bigShoe1}
          alt="shoe collection"
          width={610}
